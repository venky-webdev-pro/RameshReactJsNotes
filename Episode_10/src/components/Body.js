    ...
    return listofRestaurants.length === 0 ? <Shimmer/> :(
        <div className="body p-2">
            <div className="filter">
              <div className="search flex space-x-2 py-2">
                <input type="text" className="search-box border" onChange={(e)=>{setSearchText(e.target.value)}} value={searchText}/>
                <button className="bg-green-600 px-2 rounded text-white font-bold"
                onClick={
                  ()=>{
                ...
                >Search</button>
                <button className="filter-btn bg-blue-500 px-2 rounded text-white font-bold" onClick={()=>{
            ...
            <div className="res-container flex justify-center space-x-2 flex-wrap">
